from pyeod.model import Element, User, Poll, ElementPoll, Database, GameInstance, MarkPoll
...
types = [Element, User, Poll, ElementPoll, Database, GameInstance, DiscordGameInstance, MarkPoll]
